...
const About = () => (
    <div className="w-full h-full flex flex-col items-center px-12 pt-12 pb-6">
        ...
        <div className="transition-colors duration-300 prose prose-lg dark:prose-invert max-w-4xl mb-6">
            <p>
        ...
        <div className="transition-colors duration-300 prose prose-lg dark:prose-invert max-w-4xl w-full">
            <div className="flex items-center space-x-3">
                ...
                <a
                    ...
                    className="inline-flex items-center hover:text-black dark:hover:text-gray-400 transition-colors duration-300 no-underline"
                >
